            ...
            <div className="divMenu">
                ...
                <ul id="menu">
                    ...
                    <li>
                        ...
                        <ul>
                            <li onClick={this.showChange} onMouseOver={this.hover} onMouseOut={this.unHover}>Sản xuất</li>
                            ...
                            <li onClick={this.showChange} onMouseOver={this.hover} onMouseOut={this.unHover}>Cũ</li>
                        </ul>
                    </li>
                    <li>
